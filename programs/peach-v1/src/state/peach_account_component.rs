...
pub struct TokenPosition {
    ...
    pub indexed_position: MyFixedIdlWrapper,    // Offset 0, Size 16. Ends 16.
    ...
    pub previous_index: MyFixedIdlWrapper,      // Offset 32, Size 16. Ends 48.
    // (Display only)
    ...
    // Explicit padding to make the struct size a multiple of its alignment (16 bytes for MyFixedIdlWrapper)
