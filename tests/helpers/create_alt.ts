...
export async function createLookupTableAddress(connection: Connection, wallet: Keypair) {
    ...
    const signature = await provider.connection.sendTransaction(transaction, [wallet]);
