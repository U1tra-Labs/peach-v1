...
export async function tokenDeposit(
  deposit_amount: anchor.BN,
  marketPDA: PublicKey,
  peachAccountPDA: PublicKey,
  bankPDA: PublicKey,
  vaultPDA: PublicKey,
  oracle: PublicKey,
...
export async function tokenDepositIntoExisting(
  deposit_amount: anchor.BN,
  marketPDA: PublicKey,
  peachAccountPDA: PublicKey,
  bankPDA: PublicKey,
...
export async function tokenForceWithdraw(
  marketPDA: PublicKey,
  peachAccountPDA: PublicKey,
  bankPDA: PublicKey,
  vaultPDA: PublicKey,
...
export async function tokenChargeCollateralFees(
  marketPDA: PublicKey,
  peachAccountPDA: PublicKey
) {
  const tx = await program.methods
...
export async function tokenDeregister(
  market: PublicKey,
  admin: Keypair,
  mintInfo: PublicKey,
  dustVault: PublicKey,
